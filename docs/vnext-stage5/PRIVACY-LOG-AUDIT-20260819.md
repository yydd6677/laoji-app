...
本审计只覆盖运行日志的内容边界，不改变生产服务、数据库或公网流量。`34c488d` 已部署到隔离
`18021` 并完成 `/health`、`/api/health`、`/api/ready` 真实探测；部署记录见
[`CANDIDATE-DEPLOY-34C488D-20260819.md`](CANDIDATE-DEPLOY-34C488D-20260819.md)。
