...
> 规划估算：核心 P0/P1 框架约完成 97%，完整优化登记表（含线上闭环和 P2）约完成 93%–94%。这是功能工作量估算，不是发布通过率。
...
| C：补齐尚缺功能量 | P0/P1 尾项和五个 P2 纵切均有真实入口、持久化与失败状态 | 视频导入、到期清理、QA、组织、多场检索、轻协作、片段、时间点附件；SPK-01 框架已完成 | 不先建设复杂 Agent、团队权限树或完整编辑器 |
