...
| QA、跨会议组织、轻协作、媒体片段、时间点附件 | ORG-01 标签/分源搜索/人物与用户主题本机聚合及 ATT-01 本机附件/显式分享已闭环；其余未开始 | ORG 有 v20 和聚合夹具、ATT 有 v21 保留数据模拟器证据 | ORG 只续账号标签同步/实验 topic；推进其余独立纵切，Folder 保留需求门槛 |
