...
- Preview APK 于 `2026-07-27 11:22:03 +0800` 构建，SHA-256 为 `3e7c1317561bce9ac8cd8720fa23f29b86ce6af0c7e37a70244e64040a237b42`，已覆盖安装到真机。当前 SSH 认证拒绝 `zhong@183.36.243.124`，因此只有移动端超时修复已进入真机；证据选择候选仍未同步到运行的 18020，不得表述为线上质量修复。
