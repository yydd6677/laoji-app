...
class CalendarEditPageTestActivity : ComponentActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    page = CalendarEditPageView(this, calendarPageTestAppContext(applicationContext)).apply {
      id = PAGE_VIEW_ID
...
private var sharedCalendarPageAppContext: AppContext? = null

internal fun calendarPageTestAppContext(context: Context): AppContext =
  sharedCalendarPageAppContext ?: synchronized(CalendarEditPageTestActivity::class.java) {
    sharedCalendarPageAppContext ?: createCalendarPageTestAppContext(context).also {
      sharedCalendarPageAppContext = it
    }
  }

private fun createCalendarPageTestAppContext(context: Context): AppContext {
